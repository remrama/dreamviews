...
\DTLloaddb{liwcstats}{../output/tables/validate-liwc_scores-stats.tsv}
...
\begin{figure}[t]
    \centering
    \includegraphics{validate-wordshift_jsd-custom.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics{validate-wordshift_fear-custom.pdf}
