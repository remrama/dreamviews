...
\begin{figure*}[t]
    \centering
    \includegraphics{describe-totalcounts.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics{validate-wordshift_jsd.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics{validate-wordshift_fear.pdf}
...
\begin{figure*}[t]
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics{validate-liwc.pdf}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics{validate-liwc_insight.pdf}
    ...
    \begin{subfigure}[t]{0.3\textwidth}
        \centering
        \includegraphics{validate-liwc_agency.pdf}
