...
\bigskip
\noindent {\bf Keywords:} \emph{sleep}, \emph{dreaming}, \emph{big data}, \emph{text mining}, \emph{nlp}
...
\begin{table}[t]
    \caption{Description of datafiles.}\label{table:datafiles}
...
RM would like to thank Ashwini Ashokkumar.

\smallskip
\noindent
\textbf{Conflict.} None declared.
